...
const Projetos = () => {
  ...
  const { projetosPesquisa, projetosExtensao, projetosPesquisadoCurso, projetosExtensaodoCurso, deleteProjetoPesquisa, deleteProjetoExtensao } = useProjetos();
  ...
  const displayedProjetosPesquisa = isStudent ? projetosPesquisadoCurso : projetosPesquisa;
  const displayedProjetosExtensao = isStudent ? projetosExtensaodoCurso : projetosExtensao;
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="pesquisa">Pesquisa ({displayedProjetosPesquisa.length})</TabsTrigger>
          <TabsTrigger value="extensao">Extensão ({displayedProjetosExtensao.length})</TabsTrigger>
        </TabsList>
